...
module.exports.initSprites = function () {
    ...
    button_twitter_sprite.y = 520;
    button_twitter_sprite.touchable = true;
    button_twitter_sprite.onPointDown.add(function (ev) {
        var text = '%E3%82%A8%E3%82%A2%E3%83%BC%E3%83%8A%E3%83%AB%E3%83%9F%E3%83%A4';
    ...
    // 練習モード
    var button_ranking_sprite = Core.createSprite('/assets/image/button_practice.png', scene);
    button_ranking_sprite.scaleX = 0.75;
    button_ranking_sprite.scaleY = 0.75;
    button_ranking_sprite.x = 1120;
    button_ranking_sprite.y = 640;
    button_ranking_sprite.touchable = true;
    button_ranking_sprite.onPointDown.add(function (ev) {
        g.game.vars.mode = 'P';
        g.game.executeScene('game_scene', 'replaceScene', g.game.title_scene.param);
    });
    scene.layers.front.append(button_ranking_sprite);
}
